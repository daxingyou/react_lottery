...
export default class Group_recharge1 extends Component{
    ...
    onConfirm = (startTime, endTime) => {
        ...
        let dataStart=this.format(startTime,"-");
        let dataEnd=this.format(endTime,"-");
        let date="&start_date="+dataStart+"&end_date="+dataEnd;
        Api("c=fin&a=depositList"+date,null,(res)=>{
    ...
    handleGetdata(){
        ...
        if(this.state.page>this.state.totalpage){
            ...
            Api("c=fin&a=depositList"+page,null,(res)=>{
                ...
                let rechargeamount=Number((this.state.rechargeamount+pageAmount).toFixed(2));
    ...
    handleGetdataforoneday(){
        ...
        if(this.state.page>this.state.totalpage){
            ...
            Api("c=fin&a=depositList"+date+page,null,(res)=>{
                if(res.errno>0){
                    message.info(res.errstr);
                }
                let activityList=res.data.showDatas;//需要渲染到页面的数据
