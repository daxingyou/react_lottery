...
import { PopupConfirm, Spin } from 'antd';
            ...
            <div className="lotto-cart">
                <Spin tip="正在加载，请稍候..." spinning={this.props.loading}>
                    <ul className="tzlist">
                        ...
                        {this.props.tableList.map((list, index) =>
                            <li key={index}>
                                ...
                                <span>{list.content.map((list,i)=>list.concat("，"))}</span>
                    ...
                    <div className="beishu-wrap">
                        <div className="beishu">倍数：<input type="number" onBlur={this.props.beishuOnBlur.bind(this)}  onChange={this.props.beishuChange.bind(this)} value={this.props.beishu} /></div>
