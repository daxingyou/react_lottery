...
import { PopupConfirm, Slider,message} from 'antd';
//底部投注条
    ...
    render(){
        ...
        if(game_key==="g" || lottery_id===15){
            ...
            renderBar=<div  className="lottery-bottom-x">
                ...
                <input type="number" placeholder="输入金额" maxLength="5" pattern="[0-9]*" onChange={(e)=>{this.props.handleChangeMoney(e)}} id="jsInputMoney" ref="inputMoney" />
                {btnRender}
            </div>;
        }
