...
import Game_pks from '../pk10/Game_pks';
import Api from '../../api';
import './pks.scss';
class Pk10 extends Component {
  ...
  calcItem(cart){
      ...
      const game = new Game_pks(this.props);
      let zhushu = 0;
      let content=[];
      cart.map((item,i)=>{
          if(item){
        ...
        touzhu=
              <NumList
                  ...
                  prize={this.props.prize}//赔率
                    gamePrize={(parseFloat(this.props.md.prize[1])*this.props.gamePrize).toFixed(3)}//赔率
            ...
            <NumList
                ...
                cart={this.props.cart}//当前购物车
                prize={this.props.prize}//赔率
                  gamePrize={(parseFloat(this.props.md.prize[1])*this.props.gamePrize)}//赔率
                // gamePrize={this.props.gamePrize}
                 buttonType={this.props.buttonType}
            />
                        ...
                        <ul className="ch_num_show" style={{textAlign:"center"}} >
                            {codeArr.map((num,j)=>{
                                ...
                                return(<li key={j}>
                                    ...
                                    <label>{parseFloat((this.props.gamePrize*parseFloat(this.props.prize[level])).toFixed(3))}</label>
                                </li>)
                            })
                            }
                        </ul>
